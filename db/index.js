...
const initCampus = {
  name: 'Earth',
  photo: '/public/ugaArch.jpg',
  details: 'The oldest and true campus still existing on Earth.',
  locationType: 'Campus'
}
const initUser = {
  name: 'David',
  email: 'david@fullstack.com',
  details: 'The Original founder father of fullstack and also a name of an awesome student',
